...
module.exports = React.createClass({displayName: "exports",
    render: function() {
        return (
            React.createElement("article", {className: "frontpage-article container"}, 
              React.createElement("h1", {className: "bootstrap-override1"}, "Lorem ipsum dolor"), 
              ...
              React.createElement("h2", {className: "bootstrap-override2"}, "Morbi at tincidunt diam."), 
              ...
              React.createElement("h2", {className: "bootstrap-override2"}, "Fusce lobortis"), 
              ...
              React.createElement("h2", {className: "bootstrap-override2"}, "In viverra augue id elit tempor euismod."), 
