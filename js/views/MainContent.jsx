...
module.exports = React.createClass({
    render: function() {
        return (
            <article className="frontpage-article container">
              <h1 className="bootstrap-override1">Lorem ipsum dolor</h1>
              ...
              <h2 className="bootstrap-override2">Morbi at tincidunt diam.</h2>
              ...
              <h2 className="bootstrap-override2">Fusce lobortis</h2>
              ...
              <h2 className="bootstrap-override2">In viverra augue id elit tempor euismod.</h2>
